...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/osman/github_project/tnm-web/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./home/osman/github_project/tnm-web/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'web','api',);
        registerArgumentsSet('routes', 'home','about','contact','news.show',
'news.breaking','news.day','news.week','lang.switch','register','login','password.request','password.email',
'password.reset','password.store','verification.notice','verification.verify','verification.send',
'password.confirm','password.update','logout','admin.dashboard',
'admin.users','admin.users.delete','admin.users.toggleStatus','admin.users.changeRole','admin.books.store',
'admin.books.destroy','admin.news.index','admin.news.create','admin.news.store','admin.news.edit',
'admin.news.update','admin.news.destroy','comments.store','comment.destroy','news.like',
'books.download','dashboard','books.index','otp.form','otp.verify',
'books.store','storage.local',);
        registerArgumentsSet('views', 
'about','admin.dashboard','admin.layout','admin.news.create','admin.news.edit',
'admin.news.index','admin.users.index','auth.confirm-password','auth.forgot-password','auth.login',
'auth.register','auth.reset-password','auth.verify-email','books.create','books.index',
...
'components.responsive-nav-link','components.secondary-button','components.text-input','contact','dashboard',
'emails.otp','home','layout','layout-old','layouts.app',
'layouts.guest','layouts.navigation','news.breaking','news.day','news.index',
'news.show','otp','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form',
'profile.partials.update-profile-information-form','week','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'validation.custom.attribute-name.rule-name','messages.home','messages.about','messages.contact','messages.breaking_news',
'messages.news_of_day','messages.news_of_week','messages.dashboard','messages.login','messages.logout',
'messages.sign_up','messages.save','messages.cancel','messages.delete','messages.edit',
'messages.create','messages.update','messages.submit','messages.posted_date','messages.no_data',
'messages.search','messages.filter','messages.add_news','messages.news_title','messages.news_content',
'messages.news_type','messages.news_image','messages.news_image_optional','messages.publish_date','messages.news_list',
'messages.no_news','messages.no_news_week','messages.no_breaking_news','messages.no_news_day','messages.news_added',
'messages.news_updated','messages.news_deleted','messages.edit_news','messages.read_more','messages.summary_week',
'messages.stay_tuned','messages.comments','messages.write_comment','messages.post_comment','messages.no_comments',
'messages.login_to_comment','messages.like','messages.dislike','messages.admin_panel','messages.manage_users',
'messages.manage_news','messages.users','messages.user_name','messages.user_email','messages.user_role',
'messages.admin','messages.user','messages.status','messages.active','messages.inactive',
'messages.actions','messages.delete_user','messages.change_role','messages.breaking','messages.day',
'messages.week','messages.contact_us','messages.get_in_touch','messages.your_name','messages.your_email',
'messages.message','messages.send_message','messages.about_us','messages.tnm_news','messages.register',
'messages.remember_me','messages.forgot_password','messages.password','messages.confirm_password','messages.already_have_account',
'messages.dont_have_account','messages.welcome','messages.success','messages.error','messages.loading',
'messages.confirm_delete','messages.rights_reserved','messages.quick_stats','messages.total','messages.view_site',
